  ...
  return (
    <Link to="/restaurants">
      <div className="flex flex-row xs:w-[380px] xs:h-[150px] sm:w-[500px] sm:h-[150px] md:w-[750px] md:h-[180px] lg:w-[900px] lg:h-[300px]">
        ...
        >
          <div className='xs:px-2 sm:px-3 md:px-5 py-3 xs:w-[290px] xs:h-[150px] sm:w-[420px] sm:h-[150px] md:w-[650px] md:h-[250px] md:block xl:block text-black xs:text-[12px] sm:text-[15px] md:text-[20px] text-[20px] font-bold text-left'>
            {title}
